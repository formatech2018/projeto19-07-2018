<?php if(!class_exists('Rain\Tpl')){exit;}?><h1 class="color-fundo-titulo titulo titulo-autorizacao">Autorização de Empréstimo de Livro</h1>

<p class="p">Fica autorizado o usuário <strong><?php echo htmlspecialchars( $nome_usuario, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>, portador do cpf <strong><?php echo htmlspecialchars( $cpf, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong> e telefone <strong><?php echo htmlspecialchars( $telefone_celular, ENT_COMPAT, 'UTF-8', FALSE ); ?></strong>.</p>
...
<p class="paragrafo">Caso a devolução não seja realizada na prevista data, haverá cobrança de <strong>multa</strong> no valor diário de R$ <?php echo htmlspecialchars( $valor_diario_multa, ENT_COMPAT, 'UTF-8', FALSE ); ?>,00 correspondente ao período de atraso e as demais sessões regidas pelo referido estatuto.</p>
